...
|  Элементы  | Пузырек | Оптимизированный <br/> пузырек | Выбор   | Вставка | Вставка со<br/> смещением | Вставка <br/> оптимизированная |
|:----------:|:-------:|:------------------------------:|---------|---------|---------------------------|--------------------------------|
|    100     |  3 ms   |              1 ms              | 0 ms    | 1 ms    | 0 ms                      | 0 ms                           |
|   1 000    | 110 ms  |             122 ms             | 39 ms   | 165 ms  | 29 ms                     | 12 ms                          |
|   10 000   | 8651 ms |            8606 ms             | 3513 ms | 8283 ms | 1450 ms                   | 141 ms                         |
|  100 000   | timeout |            timeout             | timeout | timeout | timeout                   | 26609 ms                       |
| 1 000 000  | timeout |            timeout             | timeout | timeout | timeout                   | timeout                        |

|  Элементы  | Шелл     | Шелл<br/> 2k + 1 | Шелл <br/> 4^k + 2^(k - 1) + 1 | Пирамидальная |
|:----------:|----------|------------------|--------------------------------|---------------|
|    100     | 0 ms     | 0 ms             | 0 ms                           | 0 ms          |
|   1 000    | 14 ms    | 5 ms             | 6 ms                           | 9 ms          |
|   10 000   | 171 ms   | 99ms             | 80 ms                          | 128 ms        |
|  100 000   | 3881 ms  | 705 ms           | 534 ms                         | 969 ms        |
| 1 000 000  | 85724 ms | 9998 ms          | 7326 ms                        | 10232 ms      |
| 10 000 000 | timeout  | timeout          | 93037 ms                       | timeout       |

|  Элементы  | Быстрая  | Слияние  |
|:----------:|----------|----------|
|    100     | 0 ms     | 0 ms     |
|   1 000    | 2 ms     | 4 ms     |
|   10 000   | 20 ms    | 64 ms    |
|  100 000   | 474 ms   | 542 ms   |
| 1 000 000  | 3476 ms  | 5586 ms  |
| 10 000 000 | 59360 ms | 70722 ms |

| Элементы  | T   | Обычная       | 2 файла  | Предсортировка |
|:---------:|-----|---------------|----------|----------------|
|    100    | 10  | 10 ms         | 99 ms    | 4 ms           |
|   1 000   | 10  | 13 ms         | 1579 ms  | 39 ms          |
|  10 000   | 10  | 37 ms         | 70378 ms | 2650 ms        |
|  100 000  | 10  | 276 ms        | timeout  | timeout        |
| 1 000 000 | 10  | 1434 ms       | timeout  | timeout        |
|    100    | N   | 86 ms         | 210 ms   | 4 ms           |
|   1 000   | N   | 956 ms        | 2639 ms  | 43 ms          |
|  10 000   | N   | 12313 ms      | 69936 ms | 1765 ms        |
|  100 000  | N   | to many files | timeout  | timeout        |
| 1 000 000 | N   | to many files | timeout  | timeout        |

## Линейное время

|  Элементы  | Блочная | Подсчет | По основанию |
|:----------:|---------|---------|--------------|
|    100     | 0 ms    | 0 ms    | 0 ms         |
|   1 000    | 2 ms    | 1 ms    | 2 ms         |
|   10 000   | 8 ms    | 2 ms    | 9 ms         |
|  100 000   | 72 ms   | 54 ms   | 102 ms       |
| 1 000 000  | 897 ms  | 393 ms  | 1638 ms      |
| 10 000 000 | 8195 ms | 2738 ms | 15066 ms     |

## Миллиард чисел

Выполнил в упрощенном виде - 100 000 000. на 1 миллиарде оставлял
на ночь и не получил результата, возможно там повлияло ограничение памяти процесса
или другие системны ограничения.

|  Элементы   | Блочная   | Подсчет  | По основанию |
|:-----------:|-----------|----------|--------------|
| 100 000 000 | 121899 ms | 55983 ms | 380058 ms    |
